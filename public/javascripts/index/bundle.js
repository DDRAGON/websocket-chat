...
var chatTable = (0, _jquery2.default)('#chat-table');
var textArea = (0, _jquery2.default)('#text-area');
...
submitButton.click(function () {
    ...
    var escapedSendMessage = (0, _jquery2.default)('<p/>').text(textArea.val()).html();
...
socket.on('coming message', function (gotMessages) {
    messages = gotMessages;
    reWriteAllMessages(messages);
    chatTable.scrollTop(chatTable[0].scrollHeight);
});

socket.on('new message', function (newMessageObj) {
...
function createChatHtml(messageObj) {
    var chatText = '';
    var timeFormated = timeFormatter(messageObj.time);
...
function timeFormatter(time) {
    ...
    var passedDay = Math.floor(passedTime / 1000 / 60 / 60 / 24);
    var passedHour = Math.floor(passedTime / 1000 / 60 / 60);
    var passedMinutes = Math.floor(passedTime / 1000 / 60);
    var passedSeconds = Math.floor(passedTime / 1000);
